...
Begin VB.Form Form13 
   ...
   Begin MSAdodcLib.Adodc Adodc2 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "select 书号,sum(数量) as 总销量 from booksaled group by 书号 order by sum(数量) desc"
      Caption         =   "Adodc2"
